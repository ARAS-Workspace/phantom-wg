...
> **Looking for where to start?** Follow the **[Quickstart Guide](/docs/quickstart-guide)** hands-on — from server provisioning to installing and configuring **Phantom-WG** and **Phantom-Frontmatter** — alongside a chaptered video.
