...
<PhantomHLSPlayer
    ...
    chapterStrip={{
        chapters: [
            { slug: 'intro',        label: 'Introduction',                                     start: 0 },
            { slug: 'topology',     label: 'Topology Overview',                                start: 14.9 },
            { slug: 'hetzner',      label: 'Hetzner Server Provisioning',                      start: 68.33 },
            { slug: 'installation', label: 'Phantom-WG Installation & Configuration',          start: 271.23 },
            { slug: 'frontmatter',  label: 'Phantom-Frontmatter Installation & Configuration', start: 638.83 },
        ],
    }}
/>
