...
> **Nereden başlayacağınızı mı arıyorsunuz?** **[Hızlı Başlangıç Rehberi](/docs/quickstart-guide)** ile sunucu hazırlama sürecinden **Phantom-WG** ve **Phantom-Frontmatter** kurulum ve konfigürasyonuna kadar bölümlü bir video eşliğinde uygulamalı olarak izleyin.
